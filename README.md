...
- <i class="far fa-exclamation"></i> [Working with more complex data]sql
- [SQL injection]
...
- <i class="far fa-exclamation"></i> [Gitflow workflow]

### Web basics (Sessions/Flask)

- <i class="far fa-exclamation"></i> [Sessions]
- <i class="far fa-exclamation"></i> [Salted password hashing]
...
- <i class="far fa-book-open"></i> [HTTP is stateless]
- <i class="far fa-book-open"></i> [Cookies]
- <i class="far fa-book-open"></i> [Jinja2 documentation](https://jinja.palletsprojects.com/en/2.10.x/templates/)
- <i class="far fa-book-open"></i> [Collection of web resources]
